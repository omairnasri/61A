...
class Place(object):
    ...
    def add_insect(self, insect):
        ...
        """
        if insect.is_ant:
            if self.ant is None: # no current ant
                self.ant = insect
            else: # current ant exists
                # BEGIN Problem 9
...
class Insect(object):
    ...
    def reduce_armor(self, amount):
        ...
        3
        """
        # print('Reducing armor', self.armor, 'for', self)
        self.armor -= amount
        # print('Armor is now', self.armor)
        if self.armor <= 0:
            # print('removing', self, 'from', self.place)
...
class Bee(Insect):
    ...
    def blocked(self):
        ...
        # BEGIN Problem 7
        if self.place.ant and self.place.ant.blocks_path is False:
            return False
        else:
            return True
        # END Problem 7
    ...
    def action(self, colony):
        ...
        "*** YOUR CODE HERE ***"
        # END EC
        if self.blocked() and self.place.ant:
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        # Handles maximum places case 
        # Need to handle minimum cases
        j = 0
        while the_place and j < self.max_range + 1:
            val = random_or_none(the_place.bees)
            if val not in beehive.bees and val:
                # print('nearest_bee() returning', val)
                return val
            else:
                the_place = the_place.entrance
            j += 1

        # print('nearest_bee() returning None')
        # END Problem 3 and 4

    def throw_at(self, target):
        """Throw a leaf at the TARGET Bee, reducing its armor."""
        # print('in throw_at. self:', self)
        if target != None:
            # print('damage before', target.armor)
            target.reduce_armor(self.damage)
            # print('damage after', target.armor)

    def action(self, colony):
        """Throw a leaf at the nearest Bee in range."""
        # print(self)
        self.throw_at(self.nearest_bee(colony.beehive))
        # print('then armor', self.armor)
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        elif self.armor - amount > 0:
            for bee in new_bees:
                bee.reduce_armor(amount + self.damage)

        Insect.reduce_armor(self, self.damage)
        #     for bee in new_bees:
        #         bee.reduce_armor(amount)
        # END Problem 5
...
class HungryAnt(Ant):
    ...
    def action(self, colony):
        ...
        if self.digesting > 0:
            self.digesting -= 1
        elif self.digesting <= 0 and colony.bees:
...
# The WallAnt class
class WallAnt(Ant):
    """ WallAnt does nothing each turn but is useful because it has a high 
    armor value."""
    name = 'Wall'
    implemented = True
    food_cost = 4
...
class BodyguardAnt(Ant):
    ...
    def can_contain(self, other):
        # BEGIN Problem 9
        return False if self.contained_ant or other.is_container else True
        # if self.is_container and not self.ant and not other.is_container:
        #     return True
        # else:
        #     return False
        # END Problem 9
